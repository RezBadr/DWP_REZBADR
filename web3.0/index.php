...
<head>
    ...
    <link href="./src//assets//Css//footers.css" rel="stylesheet" />
                    ...
                    <div class="container px-4 py-5" id="featured-3">
                        ...
                        <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
                            <div class="feature col">
                                <a href="./src/pages/RDV.php" class="NosServices">
                            ...
                            <div class="feature col" style="height: 250px;">
                                <a href="./src/pages/Marketplace.php" class="NosServices">
                                    <div style="justify-content: center;margin:auto;">
                        ...
                        <div class="row">
                            <div class="col order-last">
                                <div class="d-grid gap-2 col-6 mx-auto">
                                    <button type="submit" class="btn btn-dark" name="rechercher"><i
                                            class="bi bi-search"></i> rechercher</button>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class=" d-flex justify-content-between align-items-center">
                                        <div class="d-grid gap-2 col-6 mx-auto">
                                            ...
                                            <button type="submit" name="afficher" class="btn btn-sm btn-warning"
                                                onclick="location.href='./src/pages/annonces.php/?<?= $produit->id_produit ?>'">Afficher
                                                l'annonce
                                            </button>
            ...
            <div class="tab-pane fade" id="pills-Employe" role="tabpanel" aria-labelledby="pills-Employe-tab">
                <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
                    <div class="col-md-5 p-lg-5 mx-auto my-5">
                        ...
                        <p class="lead fw-normal">Cette place est réservée aux employés du garage Super Cars</p>
            ...
            <footer class="py-5">
                <div class="row" style="justify-content:space-between;">
                    <div class="col-2">
                        ...
                        <ul class="nav flex-column">
                            <li class="nav-item mb-2"><a href="./src//pages//RDV.php"
                                    class="nav-link p-0 ">Entretien</a></li>
                            <li class="nav-item mb-2"><a href="./src//pages//RDV.php"
                                    class="nav-link p-0 ">Mecanique</a></li>
                            <li class="nav-item mb-2"><a href="./src//pages//RDV.php"
                                    class="nav-link p-0 ">Depannage</a></li>
                            <li class="nav-item mb-2"><a href="./src//pages//RDV.php" class="nav-link p-0 ">Vitrage</a>
                            </li>
                            <li class="nav-item mb-2"><a href="./src//pages//RDV.php"
                                    class="nav-link p-0 ">Carrosserie</a></li>
                            <li class="nav-item mb-2"><a href="./src//pages//RDV.php" class="nav-link p-0 ">Pneus</a>
                            </li>
                        </ul>
                    ...
                    <div class="col-2">
                        ...
                        <ul class="nav flex-column">
                            <li class="nav-item mb-2"><a href="https://web.facebook.com/login/?next=%2Fmarketplace%2F"
                                    class="nav-link p-0 "><i class="bi bi-facebook">
                                        Facebook</i></a></li>
                            <li class="nav-item mb-2"><a href="https://www.instagram.com/?lang=fr"
                                    class="nav-link p-0 "><i class="bi bi-instagram">
                                        Instagram</i></a></li>
                            <li class="nav-item mb-2"><a href="https://twitter.com/?lang=fr" class="nav-link p-0 "><i
                                        class="bi bi-twitter">
                                        Twitter</i></a></li>
                        </ul>
                    </div>
