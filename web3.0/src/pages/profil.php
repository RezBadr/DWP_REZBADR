            ...
            <div class="row">
                <div class="col order-last" style="justify-items: center; margin: auto;">
                    <div class="text-end" style="display: flex;">
                        ...
                        <div style="display:flex;flex-direction:column;color:#fff;font-size:x-large;">
                            <i class="bi bi-person-circle" style="justify-content: center;margin:auto;"></i>
                            <span style="justify-content: center;margin:auto;">
                        ...
                        <div style="justify-items:center;margin:auto;">
                            <a href="logout.php"> <button type="button"
                                    class="btn btn-outline-warning">Deconnexion</button></a>
                        </div>
                    </div>
                </div>
                <div class="col">
                    ...
                    <div class="container px-4 py-5" id="featured-3">
                        ...
                        <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
                            ...
                            <div class="feature col">
                                <a href="RDV.php" class="NosServices">
                                    <div style="justify-content: center;margin:auto;">
                                        <img src="../assets//images//Mecanique.png" alt="" width=50px height="50px">
                                    </div>
                                    <div style="justify-content: center;margin:auto;">
                                        <h2>Mecanique</h2>
                                    </div>
                                    ...
                                    <div class=" d-flex justify-content-between align-items-center">
                                        <div class="d-grid gap-2 col-6 mx-auto">
                                            ...
                                            <button type="submit" name="afficher" class="btn btn-sm btn-warning"
                                                onclick="location.href='annonces.php/?<?= $produit->id_produit ?>'">Afficher
                                                l'annonce
                                            </button>
                ...
                <div class="row" style="justify-content:space-between;">
                    <div class="col-2">
                        ...
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item mb-2"><a href="depannage.php" class="nav-link p-0 ">Depannage</a></li>
