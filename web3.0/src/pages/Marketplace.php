...
<body>
            ...
            <div class="container">
                <div class="container">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <MARKETPLACE class="nav-link active" id="pills-MARKETPLACE-tab" data-bs-toggle="pill"
                                data-bs-target="#pills-MARKETPLACE" type="button" role="tab"
                                aria-controls="pills-MARKETPLACE" aria-selected="true">MARKETPLACE</button>
                        </li>
                        <li class="nav-item" role="presentation">
    ...
    <main>
        <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
                            ...
                            <div class="feature col">
                                <a href="./src//pages//RDV.php" class="NosServices">
                                    <div style="justify-content: center;margin:auto;">
                                        <img src="Mecanique.png" alt="battrie" width=50px height="50px">
                                    </div>
                                    <div style="justify-content: center;margin:auto;">
                                        <h2>Mecanique</h2>
                                    </div>
            ...
            <div class="tab-pane fade show active" id="pills-MARKETPLACE" role="tabpanel"
